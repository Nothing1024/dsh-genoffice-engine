...
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry + its
// SidebarOwnerProps) into this program.
 ...
 */
export type TabsRootComponentProps =
  PropsRuntime<'sidebar'>
  & PropsRenderSlots<
    'sidebar.workspaces' | 'sidebar.settings'
    | 'sidebar.tabs.terminal' | 'sidebar.tabs.genoffice' | 'sidebar.tabs.files'
  >
  & PropsStore<ReturnType<typeof createTabsStore>>
  & TabsRootInjected
